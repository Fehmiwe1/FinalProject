    ...
    <div className="incidentPpage">
      <div className="container-Incident">
        <div className="incidentPageContainer">
          <h1 className="incident-page-title">כאן תוכל לצפות בדוחות אירועים חריגים</h1>
              ...
              {filteredIncidents.length > 0 ? (
                filteredIncidents.map((incident) => (
                  <tr key={incident.id}>
                    ...
                    <td>
                      {new Date(incident.Incident_Date).toLocaleDateString("he-IL")}
                    </td>
                    <td>
                      ...
                      {isManager && (
                        <>
                          ...
                          <button
                            ...
                            onClick={() => {
                              if (
                                window.confirm(`האם אתה בטוח שברצונך למחוק את הדוח: ${incident.Incident_Name}?`)
                              ) {
                                axios.delete(`/post/${incident.id}`).then(() => {
                                  setIncident((prev) =>
